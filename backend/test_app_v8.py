#!/usr/bin/env python3
"""
Test app v8 - Adding real routers
This app includes the real routers from main.py to test if that's the issue
"""
...
class Settings:
    ...
    def __init__(self):
        self.app_name: str = "BeSunny.ai Backend v8"
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting BeSunny.ai Python Backend v8")
    ...
    try:
        ...
        # Shutdown
        logger.info("Shutting down BeSunny.ai Python Backend v8")
...
def create_app() -> FastAPI:
    ...
    # Test including real routers
    try:
        logger.info("Testing .api.v1 router import...")
        from .api.v1 import router as api_v1_router
        app.include_router(api_v1_router, prefix="/api/v1")
        logger.info("✅ .api.v1 router included successfully")
    except Exception as e:
        logger.error(f"❌ .api.v1 router import failed: {e}")
        logger.info("Application will continue without API v1 router")
    
    try:
        logger.info("Testing .api.websockets router import...")
        from .api.websockets import router as websocket_router
        app.include_router(websocket_router, prefix="/ws")
        logger.info("✅ .api.websockets router included successfully")
    except Exception as e:
        logger.error(f"❌ .api.websockets router import failed: {e}")
        logger.info("Application will continue without websockets router")
    ...
    async def health_check():
        ...
        try:
            return {
                ...
                "timestamp": time.time(),
                "message": "Backend is running successfully with real routers"
            }
        except Exception as e:
        ...
        try:
            if static_dir.exists():
                ...
                return {
                    ...
                    "note": "Real routers loaded - testing API integration"
                }
        except Exception as e:
            return {
                "message": f"Welcome to {settings.app_name}",
...
if __name__ == "__main__":
    ...
    print(f"🔌 Mode: Testing real routers")
