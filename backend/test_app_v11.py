#!/usr/bin/env python3
"""
Test app v11 - Testing minimal core modules
This app tests the minimal core modules we created to verify imports work
"""
...
class Settings:
    ...
    def __init__(self):
        self.app_name: str = "BeSunny.ai Backend v11"
...
# Test real imports with minimal core modules
def test_real_imports():
    """Test importing the minimal core modules."""
    logger.info("Testing real imports with minimal core modules...")
    ...
    try:
        ...
        from app.core.config import get_settings as real_get_settings, is_development as real_is_development
        logger.info("✅ app.core.config import successful")
        
        # Test the imported functions
        real_settings = real_get_settings()
        logger.info(f"✅ Real config loaded: {real_settings.app_name}")
...
async def lifespan(app: FastAPI):
    """Application lifespan manager - testing real core modules."""
    # Startup
    logger.info("Starting BeSunny.ai Python Backend v11")
    
    try:
        # Test real imports first
        import_success = test_real_imports()
        if not import_success:
            logger.warning("Some imports failed, continuing with fallback services")
        ...
        # Shutdown
        logger.info("Shutting down BeSunny.ai Python Backend v11")
    ...
    async def health_check():
        ...
        try:
            return {
                ...
                "timestamp": time.time(),
                "message": "Backend is running successfully with minimal core modules"
            }
        except Exception as e:
        ...
        try:
            if static_dir.exists():
                ...
                return {
                    ...
                    "note": "Minimal core modules loaded - testing real module integration"
                }
        except Exception as e:
            return {
                "message": f"Welcome to {settings.app_name}",
...
if __name__ == "__main__":
    ...
    print(f"🔌 Mode: Testing minimal core modules with real imports")
