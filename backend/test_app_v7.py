#!/usr/bin/env python3
"""
Test app v7 - Adding lifespan function
This app includes the lifespan function from main.py to test service initialization
"""
...
class Settings:
    ...
    def __init__(self):
        self.app_name: str = "BeSunny.ai Backend v7"
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting BeSunny.ai Python Backend v7")
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"API Gateway startup failed: {e}")
        ...
        # Shutdown
        logger.info("Shutting down BeSunny.ai Python Backend v7")
    ...
    async def health_check():
        ...
        try:
            return {
                ...
                "timestamp": time.time(),
                "message": "Backend is running successfully with lifespan function"
            }
        except Exception as e:
        ...
        try:
            if static_dir.exists():
                ...
                return {
                    ...
                    "note": "Lifespan function loaded - testing service initialization"
                }
        except Exception as e:
            return {
                "message": f"Welcome to {settings.app_name}",
...
if __name__ == "__main__":
    ...
    print(f"🔌 Mode: Testing lifespan function")
