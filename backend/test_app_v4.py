#!/usr/bin/env python3
"""
Test app v4 - Adding main app structure back
This app includes the main app structure from main.py but skips complex services
"""
...
class Settings:
    ...
    def __init__(self):
        self.app_name: str = "BeSunny.ai Backend v4"
    ...
    async def health_check():
        ...
        try:
            return {
                ...
                "timestamp": time.time(),
                "message": "Backend is running successfully with main app structure"
            }
        except Exception as e:
        ...
        try:
            if static_dir.exists():
                ...
                return {
                    ...
                    "note": "Main app structure loaded - no complex services yet"
                }
        except Exception as e:
            return {
                "message": f"Welcome to {settings.app_name}",
